...
class Matrix(object):
    ...
    def Multiply(self, A):  # Standard Matrix multiplication on the right
                            # See Matrix.Multiply_L for multiplication on the left
    ...
    def getRowReduce(self):        # Badman method, algorithm from proof
                                # MA106 Theorem 3.4
        try:
...
vectors = [[1, 1, 1], [0, 1, 1], [1, 1, 0]]

A = Matrix(3, 3)
A.setMatrix_Vectors(vectors) 

print(A.toString())
print(A.getDeterminant())

Inverse_A = A.getInverse()
print(Inverse_A.toString())
